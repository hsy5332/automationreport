    ...
    if (requestdatalength > 0) {
        ...
        if (requestdatalength > 0) {
            ...
            for (var i = 0; i <= requestdatalength - 1; i++) {
                ...
                var launchtime = requests_data[i].launchtime;
                var launchtype = requests_data[i].launchtype;
                var starttime = requests_data[i].starttime;
                var endtime = requests_data[i].endtime;
