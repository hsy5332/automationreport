    ...
    if (requestdatalength > 0) {
        ...
        if (requestdatalength > 0) {
            ...
            for (var i = 0; i <= requestdatalength - 1; i++) {
                ...
                var devicesinfos = requests_data[i].devicesinfos;
                var operatetype = requests_data[i].operatetype;
                var elementcontent = requests_data[i].element;
                var parameter = requests_data[i].parameter;
                var waittime = requests_data[i].waittime;
                var runcasetime = requests_data[i].runcasetime;
                var appiumport = requests_data[i].appiumport;
                var caseexecute = requests_data[i].caseexecute;
                ...
                if (requestdatalength > displaynumber) {
                    ...
                    function draw(displaylist) {
                        $.each(displaylist, function (i, item) {
                            ...
                            html += '<td style="font-size: 11px;text-align: center;">' + item.data.parameter + '</td>';
                            html += '<td style="font-size: 11px;text-align: center;">' + item.data.waittime + '</td>';
